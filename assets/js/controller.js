...
.controller('appController', function Application($scope, $location) {
...
.controller('indexController', function($scope, contacts, $alert) {
...
.controller('addController', function($scope, contacts, $alert) {
    var alert = $alert({
        title: 'Sukces!',
...
.controller('contactController', function($scope, $routeParams, contacts, $timeout) {
...
.factory('contacts', function ContactFactory($resource) {
    var Resource = $resource('http://localhost:8080/contacts/:id', {id: '@id'}, {
        update: {method: 'PUT'}
    });
    return {
        get: function() {
